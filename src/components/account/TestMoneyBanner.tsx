...
> = {
  ...
  deposit: {
    ...
    cta: { href: "/portfolio/withdraw", label: "Заявка на вывод →" },
  },
  withdraw: {
    title: "Вывод — резерв на счёте",
    body: "При заявке сумма резервируется (списывается с доступного баланса). Реальная выплата на карту или в крипту — после E2 и PSP; оператор обрабатывает очередь в админке.",

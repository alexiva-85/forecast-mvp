...
### 2.4. Инфраструктура приложения

| Пакет | Назначение для Forecast | Блок |
|-------|-------------------------|------|
| [@sentry/nextjs](https://github.com/getsentry/sentry-javascript) | Ошибки и трейсы Next.js (клиент, сервер, Server Actions) | G4 |

### 2.5. Референс-форки (изучать)

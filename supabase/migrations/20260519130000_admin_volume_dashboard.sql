-- A9: platform volume by period + top markets (admin dashboard)
...
grant execute on function public.admin_platform_volume() to authenticated;
grant execute on function public.admin_top_markets_by_volume(int, int) to authenticated;
